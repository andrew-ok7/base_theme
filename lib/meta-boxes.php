 ...
 *
 * @category LaunchTheme
 * @package  Metaboxes
 * @license  http://www.opensource.org/licenses/gpl-license.php GPL v2.0 (or later)
 * @link     https://github.com/webdevstudios/Custom-Metaboxes-and-Fields-for-WordPress
 */

add_filter( 'cmb_meta_boxes', 'cmb_ajtok7_metaboxes' );
/**
 ...
 * @return array
 */
function cmb_ajtok7_metaboxes( array $meta_boxes ) {
	 ...
	 * Url metabox
	 */
	$meta_boxes['name_metabox'] = array(
		'id'         => 'name_metabox',
		'title'      => __( 'Name Metabox', 'cmb' ),
		...
		'fields'     => array(
			array(
				'name'       => __( 'First', 'cmb' ),
				'desc'       => __( 'first', 'cmb' ),
				'id'         => $prefix . 'name_first',
				'type'       => 'text',
			),
			array(
				'name'       => __( 'Middle', 'cmb' ),
				'desc'       => __( 'middle', 'cmb' ),
				'id'         => $prefix . 'name_middle',
				'type'       => 'text',
			),
			array(
				'name'       => __( 'Last', 'cmb' ),
			...
			array(
				'name'       => __( 'Salutation', 'cmb' ),
				'desc'       => __( 'salutation', 'cmb' ),
				'id'         => $prefix . 'name_salutation',
				'type'       => 'text',
			),
		),
	);
	 ...
	 * phone metabox
	 */
	$meta_boxes['phone_metabox'] = array(
		'id'         => 'phone_metabox',
		'title'      => __( 'Phone Metabox', 'cmb' ),
		'pages'      => array( 'directory', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'fields'     => array(
			array(
				'name'       => __( 'Office Phone', 'cmb' ),
				'desc'       => __( 'office', 'cmb' ),
				'id'         => $prefix . 'phone_office',
				'type'       => 'text',
			),
			array(
				'name'       => __( 'Mobile Phone', 'cmb' ),
				'desc'       => __( 'mobile', 'cmb' ),
				'id'         => $prefix . 'phone_mobile',
				'type'       => 'text',
			),
			array(
				'name'       => __( 'Office Fax', 'cmb' ),
				'desc'       => __( 'fax', 'cmb' ),
				'id'         => $prefix . 'phone_fax',
				'type'       => 'text',
			),
	...
	$meta_boxes['address_metabox'] = array(
		...
		'fields'     => array(
			array(
				'name'       => __( 'Street Line 1', 'cmb' ),
				'desc'       => __( 'street address', 'cmb' ),
				'id'         => $prefix . 'address_street1',
				'type'       => 'text',
			),
			array(
				'name'       => __( 'Street Line 2', 'cmb' ),
				'desc'       => __( 'street address', 'cmb' ),
			...
			array(
				...
				'options' => array(
					...
					'AR' => __( 'ARKANSAS', 'cmb' ),
					'AZ' => __( 'ARIZONA', 'cmb' ),
					'CA' => __( 'CALIFORNIA', 'cmb' ),
					'CO' => __( 'COLORADO', 'cmb' ),
					'CT' => __( 'CONNECTICUT', 'cmb' ),
					'DE' => __( 'DELAWARE', 'cmb' ),
					'FL' => __( 'FLORIDA', 'cmb' ),
					'GA' => __( 'GEORGIA', 'cmb' ),
					'HI' => __( 'HAWAII', 'cmb' ),
					...
					'KY' => __( 'KENTUCKY', 'cmb' ),
					'LA' => __( 'LOUISIANA', 'cmb' ),
					'MA' => __( 'MASSACHUSETTS', 'cmb' ),
					'MD' => __( 'MARYLAND', 'cmb' ),
					'ME' => __( 'MAINE', 'cmb' ),
					'MI' => __( 'MICHIGAN', 'cmb' ),
					'MN' => __( 'MINNESOTA', 'cmb' ),
					'MO' => __( 'MISSOURI', 'cmb' ),
					'MS' => __( 'MISSISSIPPI', 'cmb' ),
					'MT' => __( 'MONTANA', 'cmb' ),
					'NE' => __( 'NEBRASKA', 'cmb' ),
					'NC' => __( 'NORTH CAROLINA', 'cmb' ),
					'ND' => __( 'NORTH DAKOTA', 'cmb' ),
					'NH' => __( 'NEW HAMPSHIRE', 'cmb' ),
					'NJ' => __( 'NEW JERSEY', 'cmb' ),
					'NM' => __( 'NEW MEXICO', 'cmb' ),
					'NY' => __( 'NEW YORK', 'cmb' ),
					'NV' => __( 'NEVADA', 'cmb' ),
					'OH' => __( 'OHIO', 'cmb' ),
					'OK' => __( 'OKLAHOMA', 'cmb' ),
					'OR' => __( 'OREGON', 'cmb' ),
					'PA' => __( 'PENNSYLVANIA', 'cmb' ),
					'RI' => __( 'RHODE ISLAND', 'cmb' ),
					'SC' => __( 'SOUTH CAROLINA', 'cmb' ),
					'SD' => __( 'SOUTH DAKOTA', 'cmb' ),
					'TN' => __( 'TENNESSEE', 'cmb' ),
					'TX' => __( 'TEXAS', 'cmb' ),
					'UT' => __( 'UTAH', 'cmb' ),
					'VA' => __( 'VIRGINIA', 'cmb' ),
					'VT' => __( 'VERMONT', 'cmb' ),
					'WA' => __( 'WASHINGTON', 'cmb' ),
					'WI' => __( 'WISCONSIN', 'cmb' ),
					'WV' => __( 'WEST VIRGINIA', 'cmb' ),
					'WY' => __( 'WYOMING', 'cmb' ),
					'XX' => __( 'Other', 'cmb' ),
				),
			),
	...
	/**
	 * latitude and longitude metabox
	 */
	$meta_boxes['latlong_metabox'] = array(
		'id'         => 'latlong_metabox',
		'title'      => __( 'Latitude and Longitude Metabox', 'cmb' ),
		'pages'      => array( 'directory', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'fields'     => array(
			array(
				'name'       => __( 'Latitude', 'cmb' ),
				'desc'       => __( 'latitude', 'cmb' ),
				'id'         => $prefix . 'latlong_latitude',
				'type'       => 'text',
			),
			array(
				'name'       => __( 'Longitude', 'cmb' ),
				'desc'       => __( 'longitude', 'cmb' ),
				'id'         => $prefix . 'latlong_longitude',
				'type'       => 'text',
			),
		),
	);
