...
//register_nav_menu( 'topMainNav', 'Top Main Navigation' );
//register_nav_menu( 'primary', 'Primary Menu' );
register_nav_menu( 'topMainNav', 'Primary Menu' );

/*********************
MENUS & NAVIGATION
*********************/

function ok7_main_nav() {
	// display the wp3 menu if available
    wp_nav_menu( 
    	array( 
    		'menu' => 'topMainNav', /* menu name */
    		'menu_class' => '',
    		'theme_location' => 'topMainNav', /* where in the theme it's assigned */
